...
Our contracts stipulates that if this ever gets called the deed is transferred
back into the seller's name and the contract changes automatically to a lease
option with the purchase price being $1 and the end of the loan period - the
rent amount being the mortgage payment. The lease will be a typical commercial
lease where the tenant takes care of all the expenses, maintenance and repairs.

### DTI

Utilizing a payment servicing company we are able to prove a loan is being
serviced, and thus the sellers credit is cleared of 75% of the loan amount on
year 1, and 100% thereafter.
